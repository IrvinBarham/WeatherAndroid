...
public class DailyAdapter extends RecyclerView.Adapter<MyViewHolderdaily> {
    ...
    @NonNull
    @Override
    public MyViewHolderdaily onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.daily_card, parent, false);

        return new MyViewHolderdaily(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(@NonNull MyViewHolderdaily holder, int position) {
